...
wandb.init(project='MPLCRL', sync_tensorboard=True)
# wandblogger_ =  WandbLogger(
#             name = 'downtream_objdet',
#             project='MNCRL_downstream_tasks',
#             entity='mlbrl',
#         )
...
class TrainingModule(LightningModule):
    def __init__(self, cfg):
        ...
        # self.wandblogger = wandb.init(project='MNCRL_downstream_tasks', name='downstream_objdet', 'entity'=mlbrl, sync_tensorboard=True)
    ...
    def on_validation_epoch_start(self, _outputs):#_outputs
        self._reset_dataset_evaluators()

    def validation_epoch_end(self, _outputs):#_outputs
        results = self._process_dataset_evaluation_results(_outputs)#_outputs
        wandb.log(results)
...
def train(cfg, args):
    ...
    # wandb_logger.watch(module, log_freq=50)
